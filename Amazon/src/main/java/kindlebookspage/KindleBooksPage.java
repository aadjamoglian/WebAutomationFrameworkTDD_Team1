...
public class KindleBooksPage extends WebAPI {
    ...
    @FindBy(how = How.XPATH, using = kindleBooksLocator)
    public WebElement kindleBooks;
    @FindBy(how = How.XPATH, using = buyAKindleLocator)
    public WebElement buyAKindle;
    @FindBy(how = How.XPATH, using = kindleEbooksLocator)
    public WebElement kindleEbooks;
    @FindBy(how = How.CSS, using = kindleUnlimitedLocator)
    public WebElement kindleUnlimited;
    @FindBy(how = How.CSS, using = primeReadingLocator)
    public WebElement primeReading;
    @FindBy(how = How.XPATH, using = bestSellersAndMoreLocator)
    public WebElement bestSellersAndMore;
    @FindBy(how = How.XPATH, using = kindleBookDealsLocator)
    public WebElement kindleBookDeals;
    @FindBy(how = How.XPATH, using = kindleSinglesLocator)
    public WebElement kindleSingles;

    // Find By Annotation: Second Approach using public
//    @FindBy(id=searchBoxLocator) public WebElement searchBox1;
    @FindBy(xpath = newsStandLocator)
    public WebElement newsStand;
    @FindBy(xpath = manageContentAndDevicesLocator)
    public WebElement manageContentAndDevices;
    @FindBy(xpath = advancedSearchLocator)
    public WebElement advancedSearch;
    @FindBy(xpath = kindleBooksSearchBoxLocator)
    public WebElement kindleBooksSearchBox;
